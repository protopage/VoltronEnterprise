...
menus = [dropdown11, dropdown2, dropdown3, dropdown4, dropdown5, dropdownGlobal]
...
editSection1.onClick ->
	dropdownEdit.visible = false


editSection3.onClick ->
	dropdownEdit.visible = false
...
affordances = [toolbar, toolbar1, toolbar2, toolbar3, toolbar4, toolbar5, moreShit1, moreShit2, moreShit3, moreShit4, moreShit5, moreShit, dropdown11, dropdown2, dropdown3, dropdown4, dropdown5, dropdown, editClickBar]
